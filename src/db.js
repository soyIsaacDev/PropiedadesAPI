...
Organizacion.hasMany(Aliado);
Aliado.belongsTo(Organizacion);
...
TipodeUsuario.hasMany(Aliado);
Aliado.belongsTo(TipodeUsuario);
...
AsignaciondePropiedad.belongsTo(PropiedadIndependiente, { foreignKey: 'propiedadId' });
